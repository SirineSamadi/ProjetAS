<?php
 ...
 if(isset($_POST['submit'])){
            ...
            $stmt = $pdo->prepare("SELECT * FROM admin where email=? AND mdp=?");
...
<br>
        <p>Vous n'avez pas un compte avec nous? <a href="inscriptionAdmin.php">Cliquez ici pour vous inscrire!</a></p>
