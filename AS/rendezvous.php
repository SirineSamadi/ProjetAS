                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <form  method="post"  action="rendezvous.php">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <select class="form-control" style="width:auto" name="coiffeur"> 
                                <option value="default">Choisir le coiffeur :</option> 

                                <option value="Tony Tony Chopper">Tony Tony Chopper</option>

                                <option value="Nico Robin">Nico Robin</option>

                                <option value="Jolyne Cujoh">Jolyne Cujoh</option>

                                <option value="Jotaro Kujo">Jotaro Kujo</option>
                         </div>
...
if(isset($_POST['dateRdv']) && isset($_POST['heureRdv'])){
    session_start();
    ...
    if( isset($_POST['coiffeur']) && $_POST['coiffeur']!='default' )
    {

        if(($_POST['coiffeur']=="Tony Tony Chopper")){
                    $idCoiffeur = 1;

        }

        if(($_POST['coiffeur']=="Nico Robin")){
            $idCoiffeur = 4;

        }

          if(($_POST['coiffeur']=="Jolyne Cujoh")){
            $idCoiffeur = 5;

        }


          if(($_POST['coiffeur']=="Jotaro Kujo")){
            $idCoiffeur = 6;
...
$stm = $conn->prepare("insert into rendezvous (dateRdv, heureRdv, idClient, idCoiffeur) values (:dateRdv, :heureRdv, :idClient, :idCoiffeur)");
