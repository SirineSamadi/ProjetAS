         ...
         session_start();
          ...
          if(isset($_POST['submit'])){
            ...
            $idd = $_SESSION['id_user'];
                     ...
                     $stmt=$pdo->prepare("UPDATE client SET nom=?,prenom=?,telephone=?,dateNaissance=?,email=?,mdp=?
                     WHERE idClient = ?;");
                     $stmt->execute([$fname, $lname,$telephone,$dateNaissance,$email,$pwd,$_SESSION['id_user']]);
