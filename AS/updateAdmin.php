         ...
         session_start();
          ...
          if(isset($_POST['submit'])){
            ...
            $idd = $_SESSION['id_user'];
                     ...
                     $stmt=$pdo->prepare("UPDATE admin SET nom=?,adresse=?,mdp=?,email=?,dateNaissance=?,telephone=?,prenom=?
                     WHERE idClient = ?;");
                     $stmt->execute([$fname, $adresse,$pwd,$dateNaissance,$telephone,$lname,$_SESSION['id_user']]);
...
<a href="produits.php">PRODUITS</a>
  ...
  <a href="ajoutCoiffeur.php">AJOUT COIFFEUR</a>
<a href="ajoutProduits.php">AJOUT PRODUIT</a>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <form method="POST" action="updateAdmin.php">
                        <div class="row">
                            ...
                            <input class="form-control" placeholder="Votre adresse" type="text"  name="adresse">
                            </div>
